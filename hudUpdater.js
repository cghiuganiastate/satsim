...
export function initializeUI() {
  ...
  uiElements.dockingTargetLabel = document.getElementById('docking-target-label');
...
function updateDockingInfo(isDocked, dockingStatus) {
  ...
  if (uiElements.dockingTargetLabel && dockingStatus.label) {
    uiElements.dockingTargetLabel.textContent = dockingStatus.label;
  }
